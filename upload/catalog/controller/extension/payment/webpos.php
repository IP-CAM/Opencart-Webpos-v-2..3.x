...
class ControllerExtensionPaymentWebpos extends Controller {
	public function index() {
		...
		/*
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/extension/payment/webpos.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/extension/payment/webpos.tpl', $data);
		} else {
			return $this->load->view('default/template/extension/payment/webpos.tpl', $data);
		}
		*/
		return $this->load->view('extension/payment/webpos', $data);
	...
	public function instalments() {
		...
		$this->response->setOutput($this->load->view('extension/payment/webpos_instalment', $data));
	...
	public function callback(){
		...
		if ($method_response['result']==1){
			...
			echo $this->load->view('extension/payment/webpos_success', $data);
			...
			echo $this->load->view('extension/payment/webpos_failure', $data);
